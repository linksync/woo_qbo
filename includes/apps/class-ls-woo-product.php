...
class LS_Woo_Product
{
    ...
    )
    {
        ...
        if (!empty($product_meta->product_id)) {
            $lsWooProduct = new LS_Woo_Product($product_meta->product_id);
            $wooProductType = $lsWooProduct->get_type();
            $woocommerceProduct = $lsWooProduct->get_post_data();
            ...
            if ('on' == $productSyncingPriceOption) {
                ...
                if('subscription' == $wooProductType){
                    $product_meta->set('_subscription_price', $sell_price);
                }

                if('bundle' == $wooProductType){
                    $product_meta->set('_wc_pb_base_regular_price', $sell_price);
                }
