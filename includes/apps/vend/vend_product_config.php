            ...
            <!--                                                <input type = "checkbox" <?php //echo (get_option('ps_wc_to_vend_outlet') == 'on' ? 'checked' : '');
                ...
                <tr style="display:<?php echo ($product_sync_type == 'wc_to_vend' ? 'none' : ''); ?>" id="ps_cat_id_p" valign="top" class="woocommerce_frontend_css_colors">
                    ...
                    <td class="forminp">
                        ...
                        <p style="margin-left: 23px;" class="description">Use with caution as any existing product categories in WooCommerce not matching those in Vend will be deleted<br> <a href="http://docs.linksync.com/x/6gBG">Click here for more information</a>
                        </p><br>
