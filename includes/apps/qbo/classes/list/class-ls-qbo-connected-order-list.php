...
class LS_QBO_Connected_Order_List extends WP_List_Table
{
    ...
    public function column_id($item)
    {
        ...
        $actions = array(
            ...
            'edit_in_qbo' => sprintf('<a target="_blank" href="%s">Edit in QuickBooks</a>', $edit_link_in_qbo),
        );
    ...
    public function prepare_items()
    {
        ...
        if (empty($this->connected_orders)) {
            ...
            $data = LS_QBO_Order_Helper::get_qbo_connected_orders($orderBy, $order);
        }
