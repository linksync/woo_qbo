...
class LS_QBO_Product_Form{
		...
		<fieldset>
			...
			<p>
				<input
					...
					name="product_sync_type" type="radio" id="ls-qbo-two-way" value="<?php echo $this->sync_types[0]; ?>" >
				...
				<input
					...
					name="product_sync_type" type="radio" id="ls-qbo-to-woo"  value="<?php echo $this->sync_types[1]; ?>">
				...
				<input
					...
					name="product_sync_type" type="radio" id="ls-qbo-disabled"  value="<?php echo $this->sync_types[2]; ?>" >
	...
	public function confirm_sync( ){
		...
		<div id="pop_up" class="ls-pop-ups"
			...
			<div id="sync_progress_container" style="display: none;">
				...
				<center><h4 id="sync_progress"></h4></center><br/>
			...
			<div id="popup_message">
				<center>
					<div >
						<h4 id="sync_pop_up_msg">Your changes will require a full re-sync of product data <br/> Do you want to re-sync now?</h4>
					</div>
				</center>
			</div>
	...
	public function match_product_with(){
		...
		<tr valign="top">
			...
			<td class="forminp forminp-checkbox">
				<p>
					<label>
						<input type="radio" name="match_product_with" value="name" <?php echo ($option=='name')? 'checked':''; ?> >Name
					</label>
					<label>
						<input type="radio" name="match_product_with" value="sku" <?php echo ($option =='sku')? 'checked':''; ?>>SKU
					</label>
				</p>
			</td>
		</tr>
	...
	public function title_or_name(){
		...
		<tr valign="top">
			...
			<td class="forminp forminp-checkbox">
				<label>
					<input id="ls-qb-match-with" type="checkbox" <?php echo ($option=='on')? 'checked' : '';?> name="title_option">
	...
	public function price(){
		...
		<tr valign="top">
			...
			<td class="forminp forminp-checkbox">
				<label>
					<input type="checkbox" <?php echo ($option['price'] == 'on') ? 'checked' : ''; ?>  name="price" id="price_checbox">
					Sync prices between apps
				</label>

				<br><br>

				<div class="sub-option" id="price_options_container" <?php  echo ($option['price'] != 'on')? 'style="display:none;"':'' ?>>
						<span class="ps_price_sub_options">
							...
							if ('yes' == $woo_calc_taxes ) {
								?>
								<label>
									<input type="checkbox" <?php echo ($option['use_woo_tax'] == 'on') ? 'checked' : ''; ?>  name="use_woo_tax" id="use_woo_tax_checkbox">
							...
							?>
							<div class="<?php echo ( 'yes' == $woo_calc_taxes ) ? 'sub-option': ''; ?>" id="ls-qbo-tax-options" <?php echo ($option['use_woo_tax'] == 'on') ? 'style="display:none;"' : ''; ?>>
								...
								<div class="sub-option" id="use_woo_tax_container">
									<ul>
										<li>
											<label>
												<input name="tax_option" type="radio" <?php echo ($option['tax_option'] =='exclusive') ? 'checked': ''; ?> value="exclusive" > Exclusive of Tax
											</label>
										</li>
										<li>
											<label>
												<input name="tax_option" type="radio" <?php echo ($option['tax_option'] =='inclusive') ? 'checked': ''; ?> value="inclusive" > Inclusive of Tax
											</label>
										</li>
									</ul>
								</div>
	...
	public function quantity(){
		...
		?>
		<!--Quantity Table Row-->
		<tr valign="top" <?php if( isset($style) ){ echo $style; }?>>
			<th class="titledesc" <?php if( isset($th_style)) { echo $th_style; } ?>>
				<strong <?php if( isset($style) ){ echo $style; }?> >Quantity</strong>
				<?php
				help_link(array(
			...
			<td class="forminp forminp-checkbox">
				<div>
					<label>
						<input name="quantity_option" type="checkbox" <?php echo ($options['quantity']['quantity'] == 'on')? 'checked' : ''; ?> id="quantity_checkbox">
						Sync product Quantity between apps
					</label>

						<div class="ps_quanity_suboptions" id="quantity_options_container" <?php echo ($options['quantity']['quantity'] != 'on')? 'style="display:none"' : ''; ?>>
							<div id="change_product_status" class="sub-option">
								<label>
									<input name="change_product_status_option" type="checkbox" <?php echo ($options['quantity']['change_status'] == 'on')? 'checked' : ''; ?> >
	...
	public function product_status(){
		...
		<tr id="ps_create_tr" valign="top" class="woocommerce_frontend_css_colors">
			...
			<td class="forminp">
				<label>
					<input type="checkbox" name="product_status_option"  <?php echo ($option=='on') ? 'checked' : ''; ?>>
	...
	public function create_new(){
		...
		<tr id="ps_create_tr" valign="top" class="woocommerce_frontend_css_colors">
			...
			<td class="forminp">
				<label>
					<input type="checkbox" name="create_new_product_option" <?php echo ($option=='on') ? 'checked' : ''; ?>>
