...
<form class="wizard-form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
	...
	<div id="linksync_product_two_way" class="linksync_product_syncing_options" style="display:none;">
		...
		<p class="form-holder">
			...
			<br>
			<span><em>Use with caution as any existing product categories in WooCommerce not matching those in Vend will be deleted <a href="http://docs.linksync.com/x/6gBG" target="_blank">Click here for more information</a></em></span>
		</p>
		<p class="form-holder">
